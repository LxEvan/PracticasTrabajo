<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Destinatarios.aspx.cs" Inherits="QGestBotAvisos.Destinatarios" %>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="container" style="margin-top: 20px;">
                <h1 class="text-center display-4">Destinatarios - Registro</h1>
                <form id="form1" runat="server">
                    <div class="form-group">
                        <label for="mensaje">Número</label>
