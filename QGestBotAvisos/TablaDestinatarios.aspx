<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TablaDestinatarios.aspx.cs" Inherits="QGestBotAvisos.TablaDestinatarios" %>
...
<body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
        ...
        <p class="navbar-brand col-sm-3 col-md-2 mr-0" style="margin-top: 10px;"><img src="Images/logomobi.png" /></p>
    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                ...
                                Destinatarios <span class="sr-only">(current)</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-10">
                <h1 class="text-center display-4" style="margin-top:10px;">Destinatarios - Tabla</h1>
                        ...
                        <asp:GridView ID="GridView1" runat="server">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:HyperLink
                                            NavigateUrl='<%# "~/Destinatarios.aspx?id=" + HttpUtility.UrlEncode(DataBinder.Eval(Container, "DataItem.ID_Destinatario").ToString()) %>'
                                            runat="server"
                                            Text="Modificar" />
                                        |
                                           <asp:HyperLink
                                            NavigateUrl='<%# "~/BorrarDestinatarios.aspx?id=" + HttpUtility.UrlEncode(DataBinder.Eval(Container, "DataItem.ID_Destinatario").ToString()) %>'
                                            runat="server"
                                            Text="Eliminar" />
                                    </ItemTemplate>
                                </asp:TemplateField>
