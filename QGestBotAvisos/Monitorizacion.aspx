<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Monitorizacion.aspx.cs" Inherits="QGestBotAvisos.monitorizacion" %>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="container" style="margin-top: 20px;">
                <h1 class="text-center display-4">Monitorización - Registro</h1>
                <form id="form1" runat="server">
                    <div class="form-group">
                        <label for="mensaje">URL Web</label>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="destinatario">Activo</label>
                        <asp:CheckBox ID="defaultCheck2" class="form-check" type="checkbox" value="" Checked="true"  runat="server" />
                    </div> 
                    <div class="form-group">
                        <label for="destinatario">¿Conexión segura? (https)</label>
                        <asp:CheckBox ID="defaultCheck1" class="form-check" type="checkbox" value="" Checked="true"  runat="server" />
                    </div>                   
