<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TablaMonitorizacion.aspx.cs" Inherits="QGestBotAvisos.TablaMonitorizacion" %>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-10">
                <h1 class="text-center display-4" style="margin-top:10px;">Monitorización - Tabla</h1>
                        ...
                        <asp:GridView ID="GridView1" runat="server">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:HyperLink
                                            NavigateUrl='<%# "~/Monitorizacion.aspx?id=" + HttpUtility.UrlEncode(DataBinder.Eval(Container, "DataItem.ID_Monitorización").ToString()) %>'
                                            runat="server"
                                            Text="Modificar" />
                                        |
                                        <asp:HyperLink
                                            NavigateUrl='<%# "~/BorrarMonitorizacion.aspx?id=" + HttpUtility.UrlEncode(DataBinder.Eval(Container, "DataItem.ID_Monitorización").ToString()) %>'
                                            runat="server"
                                            Text="Eliminar" />
                                    </ItemTemplate>
                                </asp:TemplateField>
